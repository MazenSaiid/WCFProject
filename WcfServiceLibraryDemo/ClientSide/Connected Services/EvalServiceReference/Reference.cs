...
namespace ClientSide.EvalServiceReference {
    ...
    public interface IEvalService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/UpdateEval", ReplyAction="http://tempuri.org/IEvalService/UpdateEvalResponse")]
        void UpdateEval(int id, EvalServiceLibrary.Eval eval);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/UpdateEval", ReplyAction="http://tempuri.org/IEvalService/UpdateEvalResponse")]
        System.Threading.Tasks.Task UpdateEvalAsync(int id, EvalServiceLibrary.Eval eval);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/DeleteEval", ReplyAction="http://tempuri.org/IEvalService/DeleteEvalResponse")]
        void DeleteEval(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/DeleteEval", ReplyAction="http://tempuri.org/IEvalService/DeleteEvalResponse")]
        System.Threading.Tasks.Task DeleteEvalAsync(int id);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEvalServiceChannel : ClientSide.EvalServiceReference.IEvalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EvalServiceClient : System.ServiceModel.ClientBase<ClientSide.EvalServiceReference.IEvalService>, ClientSide.EvalServiceReference.IEvalService {
        ...
        public void UpdateEval(int id, EvalServiceLibrary.Eval eval) {
            base.Channel.UpdateEval(id, eval);
        }
        
        public System.Threading.Tasks.Task UpdateEvalAsync(int id, EvalServiceLibrary.Eval eval) {
            return base.Channel.UpdateEvalAsync(id, eval);
        }
        
        public void DeleteEval(int id) {
            base.Channel.DeleteEval(id);
        }
        
        public System.Threading.Tasks.Task DeleteEvalAsync(int id) {
            return base.Channel.DeleteEvalAsync(id);
        }
